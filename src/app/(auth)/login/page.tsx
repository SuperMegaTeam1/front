...
export default function LoginPage() {
  ...
  // TODO: Для целей подобной стилизации компонента, лучше создать отдельный компонент,
  //    который будет обёрткой для компонента MUI и будет хранить эти стили внутри себя.
  //  Вообще, лучше избегать написания стилей прямо в компоненте (выносить на уровень css),
  //    но так как cx проп требует именно JS объект, то лучше изолировать эту стилизацию, создав отдельный компонент
  //  Таким образом, компонент страницы будет содержать только верхнеуровневую логику, без внутренних деталей конкретных кнопок
  const fieldSx = {
