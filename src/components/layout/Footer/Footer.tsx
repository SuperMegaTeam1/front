          ...
          <div className={styles.col}>
            ...
            <ul className={styles.contactList}>
              <li className={styles.contactItem}>
                <LocationOnOutlinedIcon sx={{ fontSize: 20, color: 'var(--color-text-secondary)' }} />
                <span>Казань, ул. Кремлевская, д. 35</span>
              </li>
              <li className={styles.contactItem}>
                <LocalPhoneOutlinedIcon sx={{ fontSize: 20, color: 'var(--color-text-secondary)' }} />
                <span>+7 (843) 233-71-09</span>
              </li>
              <li className={styles.contactItem}>
                <MailOutlineRoundedIcon sx={{ fontSize: 20, color: 'var(--color-text-secondary)' }} />
